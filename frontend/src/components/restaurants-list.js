    ...
    return (
        <div>
            <div className="row pb-1">
                <div className="input-group col-lg-3 center py-1">
                    <input
                        type="text"
            ...
            <div className="row">
                {restaurants.map((restaurant, index) => {
                    ...
                    return (
                        <div className="col-sm center py-1" key={index}>
                            <div className="card border-primary px-2 mx-1" style={{ "minWidth": "15rem", "minHeight": "15rem" }}>
                                <div className="card-body">
                                    ...
                                    <div className="">
                                        <Link to={"/restaurants/" + restaurant["_id"]} className="btn btn-primary col-lg-7 mx-1 mb-1">
                                            View Reviews
                                        </Link>
